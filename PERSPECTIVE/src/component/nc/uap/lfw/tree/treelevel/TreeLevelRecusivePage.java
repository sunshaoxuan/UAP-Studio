...
public class TreeLevelRecusivePage extends WizardPage{
	...
	public void createControl(Composite parent) {
		setTitle(M_tree.TreeLevelRecusivePage_0); 
		setMessage(M_tree.TreeLevelRecusivePage_0);
		...
		labelId.setText(M_tree.TreeLevelRecusivePage_2);
		id = new Text(grouId, SWT.BORDER);
		id.setLayoutData(new GridData(140,15));
		id.setText(M_tree.TreeLevelRecusivePage_3);
		
		Label DatasetLabel = new Label(grouId, SWT.NONE);
		DatasetLabel.setText(M_tree.TreeLevelRecusivePage_4);
		...
		recursiveKeyFieldLabel.setText(M_tree.TreeLevelRecusivePage_5);
		...
		recursivePKeyFieldLabel.setText(M_tree.TreeLevelRecusivePage_6);
		...
		masterKeyFieldLabel.setText(M_tree.TreeLevelRecusivePage_7);
		...
		detailKeyParameterLabel.setText(M_tree.TreeLevelRecusivePage_8);
		...
		labelFieldsLabel.setText(M_tree.TreeLevelRecusivePage_11);
		...
		labelDelimsLabel.setText(M_tree.TreeLevelRecusivePage_12);
