...
public class TreeLevelCodeTreePage extends WizardPage{
	...
	public void createControl(Composite parent) {
		setTitle(M_tree.TreeLevelCodeTreePage_0); 
		setMessage(M_tree.TreeLevelCodeTreePage_0);
		...
		codeFieldLabel.setText(M_tree.TreeLevelCodeTreePage_2);
		...
		recursiveKeyFieldLabel.setText(M_tree.TreeLevelCodeTreePage_7);
		...
		recursivePKeyFieldLabel.setText(M_tree.TreeLevelCodeTreePage_8);
		...
		masterKeyFieldLabel.setText(M_tree.TreeLevelCodeTreePage_9);
		...
		detailKeyParameterLabel.setText(M_tree.TreeLevelCodeTreePage_10);
		...
		if(flag != null && flag.equals("Y")) //$NON-NLS-1$
			detailKeyParameter.setEditable(false);
		
		Label labelFieldsLabel = new Label(grouId, SWT.NONE);
		labelFieldsLabel.setText(M_tree.TreeLevelCodeTreePage_13);
...
//		labelFields.setItems((String[])list.toArray(new String[list.size()]));
		...
		labelDelimsLabel.setText(M_tree.TreeLevelCodeTreePage_14);
	...
	private void dealDefaultData(){
		if(treeobj instanceof TreeElementObj){
			...
			if(toplevel != null && toplevel instanceof CodeTreeLevel){
				...
				String[] fields = field.split(","); //$NON-NLS-1$
