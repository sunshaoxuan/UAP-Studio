 ...
 *
 */
public class AMCServiceObj extends WebElement implements Cloneable, Serializable{
...
//	private Model model;
	 ...
	 * PageMeta元素集合
	 */
	private List<LfwWindow> pmList;
	
	private List<WindowConfig> configList;
	/**
	 * View元素
	 */
	private LfwView lfwWidget;
	/**
	 * UIMeta元素
	 */
...
//	}
	public LfwView getLfwWidget() {
		return lfwWidget;
	}
	public void setLfwWidget(LfwView lfwWidget) {
...
//	}
	...
	public List<LfwWindow> getPmList() {
		return pmList;
	}
	public void setPmList(List<LfwWindow> pmList) {
		this.pmList = pmList;
	}
...
//	}
	...
	public List<WindowConfig> getConfigList() {
		return configList;
	}
	public void setConfigList(List<WindowConfig> configList) {
