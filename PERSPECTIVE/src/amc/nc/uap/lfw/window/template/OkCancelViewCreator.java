...
public class OkCancelViewCreator extends AbstractViewCreator{
	
	private static final String CANCEL_BUTTON_ID = "btn_cancel";
	private static final String OK_BUTTON_ID = "btn_ok";
	...
	protected String[] getTemplateFileName() {
		return new String[]{"okcanceltemplate.txt"};
	}
