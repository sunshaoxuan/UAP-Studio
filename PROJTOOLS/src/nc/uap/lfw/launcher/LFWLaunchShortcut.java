...
import nc.uap.lfw.lang.M_launcher;
...
//					System.setProperty("lfw_sys_type", "MIDDLEWARE");
	...
	private ILaunchConfiguration chooseConfiguration(List configList, String mode)
	{
		...
		dialog.setTitle(M_launcher.LFWLaunchShortcut_0);
		if (mode.equals(ILaunchManager.DEBUG_MODE))
		{
			dialog.setMessage(M_launcher.LFWLaunchShortcut_1);
		}
		else
		{
			dialog.setMessage(M_launcher.LFWLaunchShortcut_2);
		}
